...
if __name__ == "__main__":
    ...
    params['dataframe_pkl'] = 'july12_datasplits.pkl'
    ...
    for model in models:
        ...
        dataloaders_dict = dataloader_base.ecg_dataloader(params, mode='train')
        ...
        # train and evaluate
        model_ft, acc_hist, auc_hist = training_base.train_epochs(params, device, model_ft, dataloaders_dict,
                                                                  criterion, optimizer_ft, patience=10)

        # save the final versions
        torch.save(model_ft, params['save_path'] + '{}_best.pth'.format(params['model_name']))
        pickle.dump(acc_hist, open(params['save_path'] + "{}_acc_history.p.".format(params['model_name']), "wb"))
        pickle.dump(auc_hist, open(params['save_path'] + "{}_auc_history.p.".format(params['model_name']), "wb"))